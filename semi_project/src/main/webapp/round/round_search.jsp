			...
			<form action="main_meeting_searchListOK.do" method="get">
				<table>
					...
					<div id="nav">
						<br>
						<ul>
							<li id="round"><a href="main_round_selectAll.do" style="color: skyblue; border-bottom:skyblue">라운드</a></li>
							<li id="meeting"><a href="main_meeting_selectAll.do" style="color: gray; border-bottom: 1px solid gray">모임</a> </li>
						</ul>
					</div>
		...
		<div  class="container">
			<section  id="round_searchList">
					...
					<c:forEach var="vo" items="${vos}"> 
						<ul>
							<li><a href="round_selectOne.do?meeting_id=${vo.meeting_id}">
								<!-- 대체로 더미 이미지 (prof1) 붙임  -->
